...
export default function User(props) {
  ...
  function onFollow() {
    if (
      user.areFollowers.includes(follower._id) === "true" ||
      user.areFollowers.includes(follower._id)
    ) {
            ...
            <div className={classes.user}>
              <div className={classes.userImg}>
                ...
                {currentUser.username === user.username ? (
                  ...
                  >
                    <span>
                      {isFollowing.includes(user._id) ? "Following" : "Follow"}
                    </span>
                  </button>
                )}
              </div>
              <div className={classes.userInfo}>
                ...
                <div className={classes.userInteractions}>
                  ...
                  <div className={classes.interaction}>
                    <span className={classes.userFollowers}>
                      {user.followers}
                    </span>
